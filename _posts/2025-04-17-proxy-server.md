...
![Screenshot 1](/assets/img/Screenshot 1 - Proxy.png)

Now we have four computers! Aren't they beautiful?

![Screenshot 2](/assets/img/Screenshot 2 - Proxy.png)
...
![Screenshot 3](/assets/img/Screenshot 3 - Proxy.png)

Now we have 2 switches and 4 computers, our ecosystem is growing!

![Screenshot 4](/assets/img/Screenshot 4 - Proxy.png)
...
![Screenshot 5](/assets/img/Screenshot 5 - Proxy.png)

Our network is growing! Isn't it great?

![Screenshot 6](/assets/img/Screenshot 6 - Proxy.png)
...
![Screenshot 7](/assets/img/Screenshot 7 - Proxy.png)

Now our network is finally complete with our servers set up!

![Screenshot 8](/assets/img/Screenshot 8 - Proxy.png)
...
![Screenshot 9](/assets/img/Screenshot 9 - Proxy.png)
...
![Screenshot 10](/assets/img/Screenshot 10 - Proxy.png)

![Screenshot 11](/assets/img/Screenshot 11 - Proxy.png)
...
![Screenshot 12](/assets/img/Screenshot 12 - Proxy.png)

![Screenshot 13](/assets/img/Screenshot 13 - Proxy.png)

At the end, you should see the switches connected to the router!

![Screenshot 14](/assets/img/Screenshot 14 - Proxy.png)
...
![Screenshot 15](/assets/img/Screenshot 15 - Proxy.png)
...
![Screenshot 16](/assets/img/Screenshot 16 - Proxy.png)
...
![Screenshot 22](/assets/img/Screenshot 22 - Proxy.png)
...
![Screenshot 23](/assets/img/Screenshot 23 - Proxy.png)
...
![Screenshot 24](/assets/img/Screenshot 24 - Proxy.png)

Head to the services tab and see if **HTTP** and **HTTPS** are checked on. 

![Screenshot 25](/assets/img/Screenshot 25 - Proxy.png)
...
![Screenshot 30](/assets/img/Screenshot 30 - Proxy.png)
...
![Screenshot 31](/assets/img/Screenshot 31 - Proxy.png)
...
![Screenshot 34](/assets/img/Screenshot 34 - Proxy.png)
...
![Screenshot 35](/assets/img/Screenshot 35 - Proxy.png)
