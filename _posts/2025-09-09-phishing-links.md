...
There are many other tools that you can use, such as DNSlytics, message header analyzer, URLScan, and many more. However, for the sake of simplicity, we're just going to be using Virustotal today. 
