...
We shall repeat this process for our guest network. On the left side you'll see a Wireless Guest 2.4ghz option. Select that and you'll see the same SSID option to rename your guest network. In this case I decided to go with the most original and amazing name, **Guest**.
...
P.S I used Cisco Packet Tracer to simulate how to set up a wireless network. This process may differ from your own router at home and it won't be as simple if you're trying to switch out physical parts on your laptop or desktops. However, the premise is similar and now you're one step closer to being a networking wizard. 
